...
// If the array elements are messages then:
//   |m| must point to the minitable for the message which contains |arr|, and
//   |f| must point to the minitable for |arr|.
// Otherwise |m| and |f| must be NULL.
